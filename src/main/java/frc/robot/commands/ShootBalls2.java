...
public class ShootBalls2 extends CommandBase {
  ...
  double speed;
  double speed2;
  public ShootBalls2(double speedArg, double speed2Arg) {
    speed = speedArg;
    speed2 = speed2Arg;
  ...
  @Override
  public void execute() {
    RobotContainer.shooter.spinToRPM(Constants.shooterRPMLow);
    if(RobotContainer.shooter.currentRPM() > Constants.shooterRPMLow) {
